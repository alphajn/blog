import{_ as s,c as n,o as a,V as l}from"./chunks/framework.09a4f1e2.js";const i=JSON.parse('{"title":"Style","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"npm/style.md","lastUpdated":1683948444000}'),p={name:"npm/style.md"},o=l(`<h1 id="style" tabindex="-1">Style <a class="header-anchor" href="#style" aria-label="Permalink to &quot;Style&quot;">​</a></h1><p>基础样式scss</p><h2 id="base-scss" tabindex="-1">base.scss <a class="header-anchor" href="#base-scss" aria-label="Permalink to &quot;base.scss&quot;">​</a></h2><div class="language-scss"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;font-style:italic;">@charset</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">utf-8</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">;</span></span>
