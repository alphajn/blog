import{_ as i,c as a,a3 as n,o as l}from"./chunks/framework.Ch6Llh6T.js";const g=JSON.parse('{"title":"编辑器统一风格 editorConfig","description":"","frontmatter":{},"headers":[],"relativePath":"project/editorConfig.md","filePath":"project/editorConfig.md","lastUpdated":1716262294000}'),p={name:"project/editorConfig.md"};function t(h,s,e,k,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="编辑器统一风格-editorconfig" tabindex="-1">编辑器统一风格 editorConfig <a class="header-anchor" href="#编辑器统一风格-editorconfig" aria-label="Permalink to &quot;编辑器统一风格 editorConfig&quot;">​</a></h1><h2 id="使用说明" tabindex="-1">使用说明 <a class="header-anchor" href="#使用说明" aria-label="Permalink to &quot;使用说明&quot;">​</a></h2><p>项目根目录添加 <code>.editorconfig</code> 文件</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 告诉EditorConfig插件，这是根文件，不用继续往上查找</span></span>
