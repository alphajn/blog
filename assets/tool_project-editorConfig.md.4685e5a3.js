import{_ as s,c as n,o as a,V as l}from"./chunks/framework.8e4fecd6.js";const y=JSON.parse('{"title":"编辑器统一风格 editorConfig","description":"","frontmatter":{},"headers":[],"relativePath":"tool/project-editorConfig.md","lastUpdated":1683528362000}'),o={name:"tool/project-editorConfig.md"},e=l(`<h1 id="编辑器统一风格-editorconfig" tabindex="-1">编辑器统一风格 editorConfig <a class="header-anchor" href="#编辑器统一风格-editorconfig" aria-label="Permalink to &quot;编辑器统一风格 editorConfig&quot;">​</a></h1><h2 id="使用说明" tabindex="-1">使用说明 <a class="header-anchor" href="#使用说明" aria-label="Permalink to &quot;使用说明&quot;">​</a></h2><p>项目根目录添加 <code>.editorconfig</code></p><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;"># </span><span style="color:#FFCB6B;">告诉EditorConfig插件，这是根文件，不用继续往上查找</span></span>
